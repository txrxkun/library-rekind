...
?>
    ...
    <div id="filterForm">
        <div class="divRow">
            <div class="divRowLabel"><?php echo __('Log View Title'); ?></div>
...
<?php
    ...
    $reportgrid->setSQLColumn('b.biblio_id', 'b.title AS \''.__('Title').'\'',
        'COUNT(item_id) AS \''.__('Member Id').'\'',
        'COUNT(item_id) AS \''.__('Name').'\'',
        'pl.place_name AS \''.__('Email').'\'',
        'COUNT(item_id) AS \''.__('View').'\'');
