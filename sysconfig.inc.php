...
if (!defined('DB_NAME')) { define('DB_NAME', 'hmtifub_repository'); }
if (!defined('DB_USERNAME')) { define('DB_USERNAME', 'hmtifub_2018'); }
if (!defined('DB_PASSWORD')) { define('DB_PASSWORD', 'hmtif2018'); }
// database connection
