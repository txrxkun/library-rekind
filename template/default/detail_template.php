<div class="s-detail animated delay9 fadeInUp" itemscope itemtype="http://schema.org/Book" vocab="http://schema.org/" typeof="Book">
  ...
  <?php if ($file_att) : ?>
    <!-- query buat insert file ebook_log -->
      ...
      <table class="s-table">
        <tbody>
          ...
          <tr>
            ...
            <td>
              <div>
                <meta itemprop="inLanguage" property="inLanguage" content="<?php echo $language_name ?>" /><?php echo $language_name ?></div>
            </td>
          </tr>
          <!-- ============================================= -->
          <tr>
